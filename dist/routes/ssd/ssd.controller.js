...
const ssdSchema_1 = __importDefault(require("./ssdSchema"));
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
// !POST
const createComponent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let newComponent = new ssdSchema_1.default(req.body);
...
const updateComponent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const componentUpdated = yield ssdSchema_1.default.findByIdAndUpdate(req.body._id, req.body, {
        new: true,
    });
    if (!componentUpdated)
...
const deleteComponent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const componentFound = yield ssdSchema_1.default.findByIdAndDelete(req.params.id);
...
const getComponents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const components = yield ssdSchema_1.default.paginate({
            $or: [
...
const getComponent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const component = yield ssdSchema_1.default.findById(id);
