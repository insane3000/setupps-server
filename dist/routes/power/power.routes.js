...
// !Action Admin
router.post("/power", upload.array("files"), uploadLocal_1.uploadLocal, powerCtrl.createComponent);
router.put("/power/:id", upload.array("files"), updateLocal_1.updateLocal, powerCtrl.updateComponent);
router.delete("/power/:id", powerCtrl.deleteComponent);
