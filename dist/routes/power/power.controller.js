...
const powerSchema_1 = __importDefault(require("./powerSchema"));
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
// !POST
const createComponent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let newComponent = new powerSchema_1.default(req.body);
...
const updateComponent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const componentUpdated = yield powerSchema_1.default.findByIdAndUpdate(req.body._id, req.body, {
        new: true,
    });
    if (!componentUpdated)
...
const deleteComponent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const componentFound = yield powerSchema_1.default.findByIdAndDelete(req.params.id);
...
const getComponent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const component = yield powerSchema_1.default.findById(id);
