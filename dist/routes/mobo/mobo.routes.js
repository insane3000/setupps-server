...
router.post("/mobo", validateToken_1.tokenValidation, upload.array("files"), uploadLocal_1.uploadLocal, moboCtrl.createComponent);
router.put("/mobo/:id", validateToken_1.tokenValidation, upload.array("files"), updateLocal_1.updateLocal, moboCtrl.updateComponent);
router.delete("/mobo/:id", validateToken_1.tokenValidation, moboCtrl.deleteComponent);
