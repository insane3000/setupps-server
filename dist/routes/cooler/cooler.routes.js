...
// !Action Admin
router.post("/cooler", upload.array("files"), uploadLocal_1.uploadLocal, coolerCtrl.createComponent);
router.put("/cooler/:id", upload.array("files"), updateLocal_1.updateLocal, coolerCtrl.updateComponent);
