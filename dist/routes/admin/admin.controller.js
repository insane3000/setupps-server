...
exports.getComponent = exports.getComponents = exports.deleteComponent = exports.updateComponent = exports.checkAdmin = exports.createAdmin = void 0;
...
const createAdmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let newAdmin = new adminSchema_1.default(req.body);
...
const checkAdmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const admin = yield adminSchema_1.default.findOne({ user: req.body.user });
    ...
    const token = jsonwebtoken_1.default.sign({ _id: admin === null || admin === void 0 ? void 0 : admin._id }, `${config_1.default.SECRET}`, {
...
const updateComponent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const componentUpdated = yield adminSchema_1.default.findByIdAndUpdate(req.body._id, req.body, {
        new: true,
    });
    if (!componentUpdated)
...
const deleteComponent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const componentFound = yield adminSchema_1.default.findByIdAndDelete(req.params.id);
...
const getComponents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const components = yield adminSchema_1.default.paginate({
            $or: [
...
const getComponent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const component = yield adminSchema_1.default.findById(id);
